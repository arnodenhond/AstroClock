...
public class NextCalc {
	...
	public long getNextSSol() {
		int[] days = new int[] { 21, 21, 22, 21, 21, 21, 22 };
		int[] hours = new int[] { 15, 21, 3, 9, 15, 20, 2 };
		int[] minutes = new int[] { 59, 48, 28, 20, 3, 50, 43 };
		Calendar c = Calendar.getInstance();
		c.setTimeZone(TimeZone.getTimeZone("UTC"));
		int y = c.get(Calendar.YEAR) - 2021;
        if (y<0) y = 0;
	...
	public long getNextNSol() {
		int[] days = new int[] { 21, 21, 21, 20, 21, 21, 21 };
		int[] hours = new int[] { 3, 9, 14, 20, 2, 8, 14 };
		int[] minutes = new int[] { 32, 14, 58, 51, 42, 25, 11 };
		Calendar c = Calendar.getInstance();
		c.setTimeZone(TimeZone.getTimeZone("UTC"));
		int y = c.get(Calendar.YEAR) - 2021;
        if (y<0) y = 0;
	...
	public long getNextSEq() {
		int[] days = new int[] { 22, 23, 23, 22, 22, 23, 23 };
		int[] hours = new int[] { 19, 1, 6, 12, 18, 0, 6 };
		int[] minutes = new int[] { 21, 4, 50, 44, 20, 6, 2 };
		Calendar c = Calendar.getInstance();
		c.setTimeZone(TimeZone.getTimeZone("UTC"));
		int y = c.get(Calendar.YEAR) - 2021;
        if (y<0) y = 0;
	...
	public long getNextNEq() {
		...
		int[] hours = new int[] { 9, 15, 21, 3, 9, 14, 20 };
		int[] minutes = new int[] { 37, 33, 25, 7, 2, 46, 25 };
		Calendar c = Calendar.getInstance();
		c.setTimeZone(TimeZone.getTimeZone("UTC"));
		int y = c.get(Calendar.YEAR) - 2021;
        if (y<0) y = 0;
