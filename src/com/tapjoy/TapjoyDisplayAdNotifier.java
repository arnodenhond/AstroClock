...
/**
 * 
 * Notifier class which sends callbacks whenever receiving Banner Ad
 * data/response.
 * 
 */
public interface TapjoyDisplayAdNotifier {
	 ...
	 * 
	 * @param featuredApObject
	 *            Object containing the Banner Ad data.
	 */
	public void getDisplayAdResponse(View adView);

	/**
	 * Callback when there is no Banner Ad data returned from the server. This
	 * may be called when there are no Banner Ads available.
	 * 
	 * @param error
	 *            Error message.
	 */
