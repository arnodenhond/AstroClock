...
/**
 * 
 * The TapjoyFeaturedAppObject represents a full screen ad object and is
 * initialized when the server responds to the URL request for getting the
 * feature app data is completed.
 * 
 */
public class TapjoyFeaturedAppObject {
	...
	/**
	 * The amount of virtual currency the user gets if they complete the full
	 * screen ad offer.
	 */
	public int amount;
	...
	/**
	 * The URL to the full screen Ad. This is used when the Tapjoy Full Screen
	 * Ad web view is used to display the full screen ad.
	 */
