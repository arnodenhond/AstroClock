...
/**
 * Created by Tapjoy. Copyright 2010 Tapjoy.com All rights reserved.
 * 
 * For information about SDK integration, best practices and FAQs, please go to
 * <a href="http://knowledge.tapjoy.com">http://knowledge.tapjoy.com </a>
 */
...
public final class TapjoyConnect {
	 ...
	 * activity and before any other TapjoyConnect methods.
	 * 
	 * @param context
	...
	/**
	 * Gets the user ID assigned to this device. By default, this is the device
	 * ID.
	 * 
	...
	/**
	 * Show available offers using a currencyID and currency selector flag. This
	 * should only be used if the application supports multiple currencies and
	 * is NON-MANAGED by Tapjoy.
	 * 
	 * @param currencyID
	...
	/**
	 * Gets the virtual currency data from the server for this device. The data
	 * will be returned in a callback to updatePoints() to the class
	 * implementing the notifier.
	 * 
	 * @param notifier
	 *            The class implementing the TapjoyNotifier callback.
	 */
	 ...
	 * Tapjoy. The data will be returned in a callback to updatePoints() to the
	 * class implementing the notifier.
	 * 
	 * @param notifier
	 *            The class implementing the TapjoySpendPointsNotifier callback.
	 */
	 ...
	 * getAwardPointsResponse() to the class implementing the notifier.
	 * 
	 * @param notifier
	 *            The class implementing the TapjoyAwardPointsNotifier callback.
	 */
	...
	/**
	 * Sets the notifier which gets informed whenever virtual currency is
	 * earned.
	 * 
	 * @param notifier
	 *            Class implementing TapjoyEarnedPointsNotifier.
	 */
	...
	/**
	 * Retrieves the Full Screen Ad data from the server. Data is returned to
	 * the callback method TapjoyFeaturedAppNotifier.getFeaturedAppResponse().
	 * 
	 * @param notifier
	 *            Class implementing TapjoyFeaturedAppNotifier for the Full
	 *            Screen Ad data callback.
	 */
	 ...
	 * and is NON-MANAGED by Tapjoy.
	 * 
	 * @param currencyID
	 *            ID of the currency to award.
	 * @param notifier
	 *            Class implementing TapjoyFeaturedAppNotifier for the Full
	 *            Screen Ad data callback.
	 */
	...
	/**
	 * Sets the maximum number of times the same full screen ad should be
	 * displayed.
	 * 
	 * @param count
	 *            The maximum number of times to display a full screen ad.
	 */
	...
	/**
	 * Displays the Full Screen Ad fullscreen ad. Should be called after
	 * getFeaturedApp() and after receiving the
	 * TapjoyFeaturedAppNotifier.getFeaturedAppResponse callback.
	 */
	 ...
	 * 
	 * @param shouldAutoRefresh
	 *            Whether banner ad should auto-refresh or not.
	 */
	...
	/**
	 * Retrieves the Banner Ad data from the server. Data is returned to the
	 * callback method TapjoyFeaturedAppNotifier.getFeaturedAppResponse().
	 * 
	 * @param notifier
	 *            Class implementing TapjoyFeaturedAppNotifier for the Full
	 *            Screen Ad data callback.
	...
	/**
	 * Retrieves the Banner Ad data from the server. Data is returned to the
	 * callback method TapjoyFeaturedAppNotifier.getFeaturedAppResponse(). This
	 * should only be used if the application supports multiple currencies and
	 * is NON-MANAGED by Tapjoy.
	 * 
	 * @param currencyID
	...
	/**
	 * Initialize video ads so video offers can be made available via the offer
	 * wall. Call this method if you wish to enable video offers.
	 */
	...
	/**
	 * Sets the limit of number of videos to keep in cache. The default value is
	 * 5.
	 * 
	 * @param count
	 *            Number of videos to cache.
	 */
