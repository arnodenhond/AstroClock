...
public class TapjoyURLConnection {
	...
	public String connectToURL(String url, String params) {
		...
		try {
			...
			TapjoyLog.i(TAPJOY_URL_CONNECTION, "--------------------");
			// TapjoyLog.i(TAPJOY_URL_CONNECTION, "response status: " +
	...
	/**
	 * Gets the file size of the specified resource from the HTTP header field
	 * "content-length"
	 * 
	 * @param url
	...
	/**
	 * Performs a network request call using HTTP POST to the specified URL and
	 * parameters.
	 * 
	 * @param url
	 *            The URL to connect to.
	 * @param params
	 *            POST parameters in key/value format.
	 * @param paramsData
	 *            Any additional POST parameters in key/value format.
	 * @return Response from the server.
	 */
