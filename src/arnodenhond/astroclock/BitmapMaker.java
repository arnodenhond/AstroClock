...
public class BitmapMaker {
	...
	Bitmap makeBitmap() {
		SharedPreferences prefs = ctx.getSharedPreferences("settings", Activity.MODE_PRIVATE);

		int twilightmode = prefs.getInt("twilight", Stats.CIVIL);
		switch (twilightmode) {
			case Stats.ASTRO:zenith = SunTimes.ASTRONOMICAL_ZENITH;break;
			case Stats.NAUTIC:zenith = SunTimes.NAUTICAL_ZENITH;break;
			case Stats.CIVIL:zenith = SunTimes.CIVIL_ZENITH;break;
		}
		...
		double down = 0;
		try {
			up = SunTimes.getSunriseTimeUTC(c.get(Calendar.YEAR), c.get(Calendar.MONTH) + 1, c.get(Calendar.DAY_OF_MONTH), longitude, latitude, zenith).getFractionalHours();
			down = SunTimes.getSunsetTimeUTC(c.get(Calendar.YEAR), c.get(Calendar.MONTH) + 1, c.get(Calendar.DAY_OF_MONTH), longitude, latitude, zenith).getFractionalHours();
		...
		if (pointers) {
			BitmapDrawable bd = (BitmapDrawable) r.getDrawable(R.drawable.yearring);
			canvas.drawBitmap(Bitmap.createScaledBitmap(bd.getBitmap(), dimension, dimension, true), 0, 0, paint);
			if (north) {
				bd = (BitmapDrawable) r.getDrawable(R.drawable.moonringnorth);
			} else {
				bd = (BitmapDrawable) r.getDrawable(R.drawable.moonringsouth);
			}
			canvas.drawBitmap(Bitmap.createScaledBitmap(bd.getBitmap(), dimension, dimension, true), 0, 0, paint);
			bd = (BitmapDrawable) r.getDrawable(R.drawable.dayring);
			canvas.drawBitmap(Bitmap.createScaledBitmap(bd.getBitmap(), dimension, dimension, true), 0, 0, paint);
...
//			double base = dimension/8;
//			double ex = Math.sin(day*Math.PI) * ((base*1)+(base/2));
//			double ey = Math.cos(day*Math.PI) * ((base*1)+(base/2));
//			paint.setStrokeWidth(3);
//			paint.setColor(Color.LTGRAY);
//			canvas.drawLine(centerx, centery, (float) (centerx+ex), (float) (centery-ey), paint);
//			paint.setStrokeWidth(1);
//			paint.setColor(Color.DKGRAY);
//			canvas.drawLine(centerx, centery, (float) (centerx+ex), (float) (centery-ey), paint);
//
//			ex = Math.sin(moon*Math.PI) * ((base*2)+(base/2));;
//			ey = Math.cos(moon*Math.PI) * ((base*2)+(base/2));;
//			paint.setStrokeWidth(3);
//			paint.setColor(Color.LTGRAY);
//			canvas.drawLine(centerx, centery, (float) (centerx+ex), (float) (centery-ey), paint);
//			paint.setStrokeWidth(1);
...
//			canvas.drawLine(centerx, centery, (float) (centerx+ex), (float) (centery-ey), paint);
//
//			ex = Math.sin(year*Math.PI) * ((base*3)+(base/2));;
//			ey = Math.cos(year*Math.PI) * ((base*3)+(base/2));;
//			paint.setStrokeWidth(3);
//			paint.setColor(Color.LTGRAY);
//			canvas.drawLine(centerx, centery, (float) (centerx+ex), (float) (centery-ey), paint);
//			paint.setStrokeWidth(1);
...
//			canvas.drawLine(centerx, centery, (float) (centerx+ex), (float) (centery-ey), paint);
			...
			bd = (BitmapDrawable) r.getDrawable(R.drawable.onepointer);
			canvas.drawBitmap(Bitmap.createScaledBitmap(bd.getBitmap(), dimension, dimension, true), 0, 0, paint);
